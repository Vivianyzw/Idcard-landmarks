...
parser.add_argument('--dataset_folder', default='/home/vivian/work/data/widerface/val/images/', type=str, help='dataset path')
...
if __name__ == '__main__':
    ...
    for i, img_name in enumerate(test_dataset):
        ...
        landms = decode_landm(landms.data.squeeze(0), prior_data, cfg['variance'], num_landmarks=4)

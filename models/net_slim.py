...
class Slim(nn.Module):
    def __init__(self, cfg = None, phase = 'train', num_points=5):
        """
    ...
    def forward(self,inputs):
        ...
        ldm_regressions = torch.cat([o.view(o.size(0), -1, 2*self.num_points) for o in landm], 1)
